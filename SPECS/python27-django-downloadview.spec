%define name python27-django-downloadview
%define version 1.2
%define realname django-downloadview
...
Version: %{version}
Release: %{release}
Source: https://pypi.python.org/packages/source/d/django-downloadview/django-downloadview-%{version}.zip
License: BSD
