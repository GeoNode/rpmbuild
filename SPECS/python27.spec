...
#  The %_unpackaged_files_terminate_build macro, if set to 1, tells rpmbuild to exit if it finds files that are in the $RPM_BUILD_ROOT directory but not listed as part of the package.
%define _unpackaged_files_terminate_build 0
...
%changelog
* Mon Jul 27 2014 BerryDaniel <dberry@boundlessgeo.com> [2.7.10-1]
- Updated to 2.7.10
...
echo "%{__prefix}"/lib >>"$RPM_BUILD_ROOT"%{_sysconfdir}/ld.so.conf.d/python27.conf
...
%config %{_sysconfdir}/ld.so.conf.d/python27.conf
