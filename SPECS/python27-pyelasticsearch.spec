%define name python27-pyelasticsearch
%define version 0.6.1
%define realname pyelasticsearch
...
Version: %{version}
Release: %{release}
Source: https://pypi.python.org/packages/source/p/pyelasticsearch/pyelasticsearch-%{version}.tar.gz
License: BSD
