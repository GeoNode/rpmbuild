%define name python27-gsimporter
%define version 1.0.0
%define realname gsimporter
%define release 1%{?dist}

Summary: GeoServer Importer Client
Name: %{name}
Version: %{version}
Release: %{release}
Source: https://pypi.python.org/packages/source/g/gsimporter/gsimporter-%{version}.tar.gz
