%define name python27-django-pagination
...
Version: %{version}
Release: %{release}
Source: https://pypi.python.org/packages/source/d/django-pagination/django-pagination-%{version}.tar.gz
License: BSD
...
%changelog
* Tue Nov 17 2015 Daniel Berry <dberry@boundlessgeo.com> 1.0.7
