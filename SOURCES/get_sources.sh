...
# Script to download necessary source files to build the EL6 RPMS
# python 2.7.* source
...
wget https://pypi.python.org/packages/source/b/billiard/billiard-3.3.0.20.tar.gz
...
wget https://pypi.python.org/packages/source/d/django-haystack/django-haystack-2.1.0.tar.gz
...
wget https://pypi.python.org/packages/source/d/django-pagination/django-pagination-1.0.7.tar.gz
...
wget https://pypi.python.org/packages/source/O/OWSLib/OWSLib-0.8.13.tar.gz
...
wget https://pypi.python.org/packages/source/P/Pillow/Pillow-2.9.0.tar.gz
...
wget https://pypi.python.org/packages/source/p/pycsw/pycsw-1.10.3.tar.gz
wget https://pypi.python.org/packages/source/p/pyelasticsearch/pyelasticsearch-0.6.1.tar.gz
wget https://pypi.python.org/packages/source/p/pyflakes/pyflakes-0.9.2.tar.gz
...
wget https://pypi.python.org/packages/source/r/regex/regex-2015.07.12.tar.gz
wget https://pypi.python.org/packages/source/r/requests/requests-2.7.0.tar.gz
wget https://pypi.python.org/packages/source/S/Shapely/Shapely-1.3.1.tar.gz
wget https://pypi.python.org/packages/source/s/simplejson/simplejson-3.7.3.tar.gz
...
wget https://pypi.python.org/packages/source/u/uWSGI/uwsgi-2.0.11.1.tar.gz
##########
# geonode-project
wget https://github.com/GeoNode/geonode-project/archive/master.zip && mv master.zip geonode-project.zip
##########
# geonode-geoserver war file
